...
class LoadDetailSchema(BaseModel):
    ...
    def from_load(
        ...
        *,
        ...
        return cls(
            id=load.id,
            default_message_on_bid="<div style=\"font-family:Arial, sans-serif; width:100%; height:100%;\">    <table role=\"presentation\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"           style=\"max-width:600px; width:100%; background-color:#ffffff; border-radius:10px; overflow:hidden; border: 1px solid #cfcfcf\">      <tr>          <td style=\"border-top: 20px solid #1e82ba; padding:20px 30px; text-align:left; color:#333333; font-size:14px; line-height:1.6; height: auto;\">          <p><b>RATE:</b> <span id=\"broker_price\">$[broker_price]</span></p>          <p><b>DIMENSIONS:</b> <span id=\"dimension\">[dimension]</span></p>          <p><b>MILES OUT:</b> <span id=\"miles\">[miles]</span></p>          <p><b>MC:</b> <span id=\"mc\">846834</span></p>          <p><b>VEHICLE:</b> <span id=\"vehicle_type\">[vehicle_type]</span></p>          <p><b>Truck equipment:</b> <span id=\"equipment\">[equipment]</span></p>          <span style=\"display: inline-block; background:#ffffff; color: #1e82ba; margin-top: 6px; font-weight: bold; padding: 10px 8px;border: 2px solid #1e82ba; border-radius: 0px;\">          ALL BIDS ARE VALID 15 MINUTES!        </span>        </td>      </tr>      <tr>        <td style=\"padding:0 30px; height: auto;\">          <hr style=\"border:0; height:1px; background-color:#e6e6e6;\">        </td>      </tr>      <tr>      <td style=\"padding:20px 30px; font-size:0; height: auto;\">        <div style=\"display:inline-block; vertical-align:middle; width:180px; margin-right:20px;\">          <img src=\"https://atrek-tms.s3.amazonaws.com/cargo_empire/media/logo/logo_color.jpg\"               alt=\"Logo\" width=\"180\"               style=\"border-radius:8px; border:1px solid #ddd; display:block;\">        </div>        <div style=\"display:inline-block; vertical-align:top; font-size:14px; color:#333333;\">          <p style=\"margin:4px 0; color:#000000; font-weight:bold;\">SHIPLUXE LLC</p>          <p style=\"margin:4px 0;\">MC <span class=\"wmi-callto\">846834</span></p>          <p style=\"margin:6px 0;\">Address: 10921 Reed Har tman Highway STE 323,</p>          <p style=\"margin:6px 0;\">Cincinnati, OH 45242</p>          <p style=\"margin:6px 0;\">Phone: 630-426-3362</p>          <p style=\"margin:6px 0;\">operation@shipluxellc.com</p>        </div>      </td>    </tr>      <tr>        <td style=\"padding:20px 30px; font-size:14px; color:#333333; height: auto;\">          <p style=\"margin:0; font-weight:bold; font-size:16px; color:#000000;\">[dispatcher_name]</p>          <p style=\"margin:6px 0;\"><b>&#9993;:</b> <a href=\"mailto:[dispatcher_email]\" style=\"color:#2b5876; text-decoration:none;\">[dispatcher_email]</a></p>          <p style=\"margin:6px 0;\"><b>&#9742;:</b> <span class=\"wmi-callto\">[dispatcher_phone]</span></p>        </td>      </tr>      <tr>        <td style=\"padding:20px; text-align:center; background-color:#f9fafc; font-size:12px; color:#999999; height: auto;\">          © SHIPLUXE LLC        </td>      </tr>    </table>  </div>",
            pick_up_at=load.pick_up_at,
